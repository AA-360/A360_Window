...
public final class ListWindowsCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(ListWindowsCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    ListWindows command = new ListWindows();
    ...
    try {
      Optional<Value> result =  Optional.ofNullable(command.action((String)convertedParameters.get("name")));
